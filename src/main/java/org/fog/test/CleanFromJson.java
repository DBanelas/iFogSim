...
import org.fog.utils.ConsoleMetricsExporter;
import org.fog.utils.JsonToTopology;
import org.fog.utils.MetricsExporter;
...
public class CleanFromJson {
	...
	private void printTopology(PhysicalTopology physicalTopology){
	...
	private static Application createApplication(String appId, int userId){
		...
		// add a periodic edge
		application.addAppEdge("TEMP", "client", 100.0, 1000, 100, "TEMP", Tuple.UP, AppEdge.SENSOR);
